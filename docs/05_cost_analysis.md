...
|---|---:|---|
| AWS region | `ap-southeast-2` | Region đã cấu hình cho shared sandbox account |
...
- [x] Region/account pricing final là gì? — `ap-southeast-2` trên shared sandbox AWS account.
