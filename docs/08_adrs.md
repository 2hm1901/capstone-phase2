...
- **Decision:** CDO08 host AI Engine Runtime bằng ECS Fargate stateless FastAPI, internal ALB ingress, ECS task trong private subnet, port 8080, `/health`, `POST /v1/predict`, IAM SigV4, baseline storage trên S3 mã hóa KMS.
- **Consequence:**
