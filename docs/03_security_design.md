...
- [x] CDO08 VPC/subnet/security group/ALB path cho AI Engine chốt chưa? — *Chốt theo contract: internal ALB ingress, ECS task private subnet, Serving Adapter Lambda trong AI VPC, không VPC peering.*
